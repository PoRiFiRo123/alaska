...
module.exports = async (client) => {
            ...
            if (mPrefix.includes(client.user.id)) {
                message.channel.send({
                    embeds: [new Discord.MessageEmbed()
                        .setColor("WHITE")
                        .setTitle(`<a:yes:989961664600375366> **To See All Commands Type:** \`${config.prefix}help\` ! `)
                    ]
                });
    ...
    client.on('messageCreate', async message => {
        ...
        if (cmd == "nodestats") {
            const online = `<a:Online_Ping:993084931515359263>>`;
            const offline = `<a:zen_offline:993085191105019997>`;
            const embed = new Discord.MessageEmbed()
                .setColor(client.config.color)
                .setAuthor("Astrom | Nodestats", message.guild.iconURL({
                    dynamic: true
                }), "https://bit.ly/3NJDSFP")
            ...
            if (message.member.permissions.has("ADMINISTRATOR")) {
                let embed = new Discord.MessageEmbed()
                    .setTitle("Astrom | Ticket Support")
                    .setDescription(`This is the official [Astrom](https://bit.ly/3NJDSFP) ticket support.\n\nOptionally, you can contact us by email **support@Astrom.me**`)
                    .setColor(client.config.color)
            ...
            if (message.member.permissions.has("ADMINISTRATOR")) {
                ...
                let embed = new Discord.MessageEmbed()
                    .setTitle("Astrom | Order")
                    .setDescription(`
<a:arrowr:991128350628270170> **Please take a Look at our [prices](https://discord.com/channels/929959443607748689/990585175983415386)**
...
<a:arrowr:991128350628270170>  ***To open a Order-Ticket click on the Selection down below!***`)
                    .setDescription(`
If you want to buy a Bot from [Astrom](https://bit.ly/3NJDSFP) and you checked the [prices](https://discord.com/channels/929959443607748689/990585175983415386) first, chose your wished bot in the drop-down menu down below.
\n***Available Bots are:***\n
> - **System Bot** 🤖
> 
> - **MusicBot** 🎵
...
> 
> - **Waitingroom Bot** 🕐
\nFor further questions about our pricing, please contact our marketing team at **marketing@Astrom.me**`)
                    .setColor(client.config.color)
                let menuoptions = require("../settings.json").ordersystem;
                //define the selection
                let Selection = new MessageSelectMenu()
                ...
                let PingButton = new MessageButton().setStyle("PRIMARY")
                    .setEmoji(`<:ping:990605193404108810>`)
                    .setLabel("Ping Me BEFORE!")
                    .setCustomId("PINGMEBEFORE");
                let CheckPrices = new MessageButton().setStyle('LINK')
                    .setURL('https://discord.com/channels/929959443607748689/990585175983415386')
                    .setLabel('Check the Prices')
                    .setEmoji(`<a:Money_Price:993090318582947890>`);
            ...
            async function menuselection(interaction) {
                ...
                try {
                    ...
                    let Questions = [
                        ...
                        `What should be the AVATAR? | Its For the ${menuoptiondata.value}!\nExample: "https://cdn.discordapp.com/attachments/936985190016897055/938497637060079706/LogoAstrom.png"`,
                        ...
                        setTimeout(async () => {
                            ...
                            message.channel.send({
                                ...
                                embeds: [new Discord.MessageEmbed().setColor(client.config.color).addField("📯 Invite link: ", `> [Click here](https://discord.com/oauth2/authorize?client_id=${botuser.id}&scope=bot&permissions=8)`)
                                    ...
                                    .addField(`<:Like:934494916241948763> Rate us on TRUSTPILOT`, `> ***We would love it, if you could give us a __HONEST__ Rating on [Trustpilot](https://de.trustpilot.com/review/Astrom.me)*** <3`)
                                ]
                            })
                            ch.send({
                            ...
                            fse.copy(srcDir, destDir, {
                                ...
                                .then(async () => {
                                    ...
                                    message.channel.send({
                                        ...
                                        embeds: [new Discord.MessageEmbed().setColor(client.config.color).addField("📯 Invite link: ", `> [Click here](https://discord.com/oauth2/authorize?client_id=${botuser.id}&scope=bot&permissions=8)`)
                                            .addField("💛 Support us", `> **Please give us <#${mainconfig.FeedBackChannelID.toString()}> and stop at <#${mainconfig.DonationChannelID.toString()}> so that we can continue hosting Bots!**`).setTitle(`\`${botuser.tag}\` is online and ready 2 be used!`).setDescription(`<@${botuser.id}> is a **${BotType}** and got added to: <@${owner}> Wallet!\nTo get started Type: \`${prefix}help\``).setThumbnail(botuser.displayAvatarURL())
                                            .addField("Rate us on TRUSTPILOT", `> ***We would love it, if you could give us a __HONEST__ Rating on [Trustpilot](https://de.trustpilot.com/review/Astrom.me)*** <3`)
                                        ]
                                    })
                                    ch.send({
                                        content: `✅ ***BOT CREATION WAS SUCCESSFUL***\n\n> Here is just the Bot Creation Information, if the Bot User needs Support etc. so that you have access to it!\n\n> **Go back**: <#${message.channel.id}>`,
         ...
         */
            ...
            message.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        .setColor(client.config.color)
                        .setAuthor("Astrom | Free Bots Shop | How to Order", message.guild.iconURL({
                            dynamic: true
                        }), "https://discord.gg/notsaksh")
                        ...
                        .setFooter("Astrom.me | Order Free Bots NOW", "https://cdn.discordapp.com/attachments/936372059305566219/964968487250436206/unknown.png")
            ...
            message.reply({
                embeds: [
                    new Discord.MessageEmbed()
                        .setColor(client.config.color)
                        .setAuthor("Astrom | Free Bots Shop | How to Pay", message.guild.iconURL({
                            dynamic: true
                        }), "https://discord.gg/notsaksh")
                ...
                message.reply({
                    ...
                    embeds: [
                        new Discord.MessageEmbed().setColor(client.config.color)
                            .setTitle(`Astrom Development | Get Free/Cheap Discord Bots for your needs!`)
                            ...
                            .setFooter(`Astrom Development | Order Today! Order Cheap!`, message.guild.iconURL({
                                dynamic: true
                            }))
                    ]
                })
            ...
            if (!args[0]) {
                ...
                message.reply({
                    embeds: [new Discord.MessageEmbed().setColor(client.config.color)
                        .setFooter("Astrom | Free Bots | ORDER NOW", message.guild.iconURL({
                            dynamic: true
                        }))
         ...
         */
            ...
            try {
                ...
                message.channel.send({
                    embeds: [new Discord.MessageEmbed()
                        .setColor("WHITE")
                        .setTitle("Astrom Development | Evaluation")
