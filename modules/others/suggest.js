...
if (message.channel.id == "993064775187693608") {
     setTimeout(() => {
     ...
     await suggestReplace.react(`<a:tick:989969101311066133>`).then(() => { }).catch(e => { console.log(String(e.stack).grey) });
     await suggestReplace.react("<a:no:989961174546268190>").then(() => { }).catch(e => { console.log(String(e.stack).grey) })
    }
    })
}