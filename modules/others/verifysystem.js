    ...
    client.on("interactionCreate", async (interaction) => {
        ...
        if (channel.id == RulesChannel.toString() && interaction?.customId == "okay-go-ahead") {
            interaction?.update({
                ...
                components: [
                    new MessageActionRow().addComponents([
                        new MessageButton().setLabel("PoRiFiRo").setStyle("SECONDARY").setCustomId("PoRiFiRo"),
                        new MessageButton().setLabel("PoRiFiRo").setStyle("SECONDARY").setCustomId("PoRiFiRo"),
                        new MessageButton().setLabel("PoRiFiRo").setStyle("SECONDARY").setCustomId("PoRiFiRo"),
                        new MessageButton().setLabel("PoRiFiRo").setStyle("SECONDARY").setCustomId("PoRiFiRo"),
                        new MessageButton().setLabel("PoRiFiRo").setStyle("SECONDARY").setCustomId("PoRiFiRo"),
        ...
        if (channel.id == rulesChannel && interaction?.customId.startsWith("Key")) {
            if (interaction?.customId == "PoRiFiRo") {
                interaction?.update({
                    ephemeral: true,
                ...
                interaction?.update({
                    ...
                    components: [
                        new MessageActionRow().addComponents([
                            new MessageButton().setLabel("PoRiFiRo").setStyle("DANGER").setCustomId("PoRiFiRo").setDisabled(),
                            new MessageButton().setLabel("PoRiFiRo").setStyle("DANGER").setCustomId("PoRiFiRo").setDisabled(),
                            new MessageButton().setLabel("PoRiFiRo").setStyle("DANGER").setCustomId("PoRiFiRo").setDisabled(),
                            new MessageButton().setLabel("PoRiFiRo").setStyle("SUCCESS").setCustomId("PoRiFiRo").setDisabled(),
                            new MessageButton().setLabel("PoRiFiRo").setStyle("DANGER").setCustomId("PoRiFiRo").setDisabled(),
                        ])
                    ]
                }).catch(() => { });
