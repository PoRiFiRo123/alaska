...
function GetBot(message, arg) {
    var errormessage = `<a:no:989961174546268190> I Failed Finding That Bot...`;
    return new Promise(async (resolve, reject) => {
        ...
        if (!user && args[0] && args[0].length == 18) {
            ...
            return reject(`<a:no:989961174546268190> **User Is Not A Discord Bot**...`)
        } else if (!user && args[0]) {
...
function GetUser(message, arg) {
    var errormessage = `<a:no:989961174546268190> I failed finding that User...`;
    return new Promise(async (resolve, reject) => {
        var args = arg,
            client = message.client;
        if (!client || !message) return reject("CLIENT IS NOT DEFINED")
...
function theDB(client, guild) {
    ...
    **Please tell us all of those Informations!** | Otherwise, we can't create your Bot quickly!
    > 
    > <a:arrowr:991128350628270170> **\` 1. \` What should be the Bot Name?**
    > *(The Bot's Username)*
    > 
    > <a:arrowr:991128350628270170> **\` 2. \` What should be the PREFIX?**
    > *(The Letter(s) Infront of each Command, e.g: \`!\`)*
    > 
    > <a:arrowr:991128350628270170> **\` 3. \` What should be the AVATAR?**
    > *(The Bot's Profile Picture)*
    > 
    > <a:arrowr:991128350628270170> **\` 4. \` What should be the EMBED COLOR?**
    > *(The Color on the Left Side of Embeds)*
    > 
    > <a:arrowr:991128350628270170> **\` 5. \` What should be the STATUS?**
    > *(e.g: \`!help | https://discord.io/astrom\`)*
    > 
    > <a:arrowr:991128350628270170> **\` 6. \` What should be the STATUS TYPE?** 
    > *(\`PLAYING\` / \`WATCHING\` / \`LISTENING\` / \`STREAMING\` / \`COMPETING\`)*
    > 
    <a:arrowr:991128350628270170> Do you have any wishes?

    __**Price:**__
    > \`8 Invites\`, \`1€ / Month\`, \`8€ / Year\`

    __**Payment Methods:**__
    > [Paypal](https://paypal.me/nishitrk), PaySafe, Sofort, Boosting or \`INVITES\`
    ...
    **Please tell us all of those Informations!** | Otherwise, we can't create your Bot quickly!
    ...
    __**Payment Methods:**__
    > [Paypal](https://www.paypal.me/nishitrk), [PaySafe Card, Sofort, Others](https://bit.ly/3NJDSFP), \`INVITES\`
    ...
    *Someone will help you soon*`,
    ...
    \`\`\`
    <a:arrowr:991128350628270170> **What Source Code do you want?**
    ...
    __**Payment Methods:**__
    > [Paypal](https://www.paypal.me/nishitrk), [PaySafe Card, Sofort, Others](https://bit.ly/3NJDSFP)
    ...
    \`\`\`
    <a:arrowr:991128350628270170> Name, Prefix, Avatar, Colorschema
    <a:arrowr:991128350628270170> Features, If Music, Lavalink yes/no?
    <a:arrowr:991128350628270170> When do you need it to be finished?
    <a:arrowr:991128350628270170> How much are you willing to spend?
    ...
    **Please tell us all of those Informations!** | Otherwise, we can't create your Bot quickly!
    ...
    __**Payment Methods:**__
    > [Paypal](https://paypal.me/nishitrk), PaySafe Card, Sofort, Boosting once or \`INVITES\`
...
async function swap_pages2(client, message, embeds) {
    ...
    collector.on('collect', async b => {
        if (b?.user.id !== message.author.id)
            return b?.reply({ content: `<a:no:989961174546268190> **Only The One Who Typed ${config.prefix}help Is Allowed To React!**`, ephemeral: true })
        //page forward
        if (b?.customId == "1") {
